...
from .commands import convert, models, output, queue, run, system, template
...
app.add_typer(template.app, name="template", help="Prompt template management")
app.command(name="run")(run.run_workflow)
app.command(name="convert")(convert.convert_workflow)
